                    ...
                    <div class="col-md-12">
                        <form action="{{ route('brand.update',['brand' => $brand->id]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Nhập tên thương hiệu" value="{{ $brand->name }}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    <img width="150" src="{{ url($brand->logo) }}" class="img-thumbnail">
                                </div>
