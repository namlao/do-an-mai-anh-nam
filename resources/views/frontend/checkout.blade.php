                                    ...
                                    <div id="payment-address-content"
                                        ...
                                        <div class="panel-body row">
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="firstname" class="form-control" name="firstname"
                                                           value="{{ auth()->check()?$customer->first_name:old('firstname') }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="lastname">Tên <span class="require">*</span></label>
                                                    <input type="text" id="lastname" class="form-control" name="lastname"
                                                           value="{{ auth()->check()?$customer->last_name:old('lastname') }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="email">Email <span class="require">*</span></label>
                                                    <input type="text" id="email" class="form-control" name="email"
                                                           value="{{ auth()->check()?$user->email:old('email') }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="phone">Số điện thoại <span
                                                            class="require">*</span></label>
                                                    <input type="text" id="phone" class="form-control" name="phone"
                                                           value="{{ auth()->check()?$customer->phone:old('phone') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="ward">Phường,Xã <span class="require">*</span></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="address" name="address"
                                                           class="form-control" value="{{ auth()->check()?$customer->address:old('address') }}">
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="col-md-12">
                                        ...
                                        <div class="panel-body row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="radio-list">
                                                    ...
                                                    <label>
                                                        <input type="radio" name="payment_method"
                                                               value="online" onclick="return alert('Chức năng đang phát triển')">
                                                        Thanh toán online
                                                    </label>
                                                </div>
                                                <div class="form-group">
                                                        ...
                                                        @foreach($cart as $item)
                                                            <tr>
                                                                ...
                                                                <td class="checkout-description">
                                                                    <h3><a href="{{ route('item',['id'=>$item->id]) }}">{{ $item->name }}</a>
                                                                    </h3>
                                                                ...
                                                                <td class="checkout-total">
                                                                    <strong>{{ $item->price*$item->qty }} <span>VND</span></strong>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </table>
